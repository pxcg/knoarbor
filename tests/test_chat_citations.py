...
class ChatCitationPolicyTests(unittest.TestCase):
    def test_returns_evidence_pack_pages_in_citation_order(self) -> None:
        ...
        self.assertEqual([citation.path for citation in presentation.citations], ["concepts/Agent-Loop.md", "entities/OpenClaw.md"])
    ...
    def test_validates_model_selected_citations_against_trace(self) -> None:
        ...
        self.assertEqual(presentation.citations[0].path, "concepts/Agent-Loop.md")
    ...
    def test_answer_references_override_broad_model_selected_citations(self) -> None:
        ...
        self.assertEqual([citation.path for citation in presentation.citations], [f"concepts/Page-{index}.md" for index in range(1, 5)])
    ...
    def test_answer_references_choose_matching_evidence_order(self) -> None:
        ...
        self.assertEqual([citation.path for citation in presentation.citations], ["concepts/B.md"])
    ...
    def test_sparse_answer_references_are_renumbered_with_filtered_citations(self) -> None:
        ...
        self.assertEqual(
            ...
            ["concepts/Page-1.md", "concepts/Page-7.md", "concepts/Page-10.md"],
        )
    ...
    def test_query_evidence_without_answer_refs_keeps_answer_bearing_sources(self) -> None:
        ...
        self.assertEqual(presentation.citations[4].path, "concepts/Page-5.md")
        self.assertEqual(presentation.citations[5].path, "concepts/Page-6.md")
    ...
    def test_list_pages_with_explicit_refs_can_become_public_citations(self) -> None:
        ...
        self.assertEqual([citation.path for citation in presentation.citations], ["concepts/Page-1.md", "concepts/Page-6.md"])

    def test_read_wiki_page_single_page_answer_keeps_one_citation(self) -> None:
        trace = [
            ChatToolTraceItem(
                tool="read_wiki_page",
                citations=[ChatCitation(kind="page", path="concepts/Agent-Loop.md", title="Agent Loop")],
                result={"path": "concepts/Agent-Loop.md", "content": "Agent loop content."},
            )
        ]
