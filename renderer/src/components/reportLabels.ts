...
const reportLabelKeys: Record<string, string> = {
  ...
  repair_plan: "reportLabel.repairPlan",
  repair_results: "reportLabel.repairResults",
...
const directReportLabels: Record<string, { en: string; zh: string }> = {
  ...
  raw_evidence_index: { en: "Raw evidence index", zh: "原文证据索引" },
  raw_evidence_units: { en: "Raw evidence units", zh: "原文证据单元" },
  raw_grounded: { en: "Raw-grounded evidence", zh: "原文依据链路" },
  raw_record_id: { en: "Raw record ID", zh: "Raw 记录 ID" },
  ...
  source_processing_record: { en: "Source processing record", zh: "资料处理记录" },
...
const reportSectionKeys: Record<string, string> = {
  ...
  repair_plan: "reportSection.repairPlan",
  repair_results: "reportSection.repairResults",
...
export function localizeReportValue(value: string, t: (key: string) => string): string {
  ...
  const enValues: Record<string, string> = {
    ...
    running: "Running",
    skipped: "Skipped",
    structured: "Structured organize",
    true: "Yes",
    unchanged: "Unchanged",
