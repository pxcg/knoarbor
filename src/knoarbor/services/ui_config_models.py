...
DEFAULT_CHAT_RAW_OUTPUT_DIR = "./wiki/raw/chats"
DEFAULT_MARKDOWN_RAW_OUTPUT_DIR = "./wiki/raw/notes"
DEFAULT_MINERU_MARKDOWN_OUTPUT_DIR = "./wiki/raw/documents/markdown"
