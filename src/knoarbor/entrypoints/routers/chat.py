...
def create_chat_router(services: ApplicationServices) -> APIRouter:
    ...
    async def list_chat_sessions(
        ...
        target = session_target(
            ChatRequest(config_path=config_path, vault_path=vault_path, vault_id=vault_id, messages=[{"role": "user", "content": "list sessions"}])
        )
    ...
    async def read_chat_session(
        ...
        target = session_target(
            ChatRequest(config_path=config_path, vault_path=vault_path, vault_id=vault_id, messages=[{"role": "user", "content": "read session"}])
        )
    ...
    async def delete_chat_session(
        ...
        target = session_target(
            ChatRequest(config_path=config_path, vault_path=vault_path, vault_id=vault_id, messages=[{"role": "user", "content": "delete session"}])
        )
    ...
    async def delete_chat_turn(
        ...
        target = session_target(
            ChatRequest(config_path=config_path, vault_path=vault_path, vault_id=vault_id, messages=[{"role": "user", "content": "delete turn"}])
        )
    ...
    async def update_chat_session(
        ...
        target = session_target(
            ChatRequest(
                ...
                messages=[{"role": "user", "content": "update session"}],
            )
        )
    ...
    async def close_chat_session(
        ...
        return close_chat_session_workflow(services, session_id, request or ChatSessionCloseRequest())
    ...
    async def retry_chat_session_turn(
        ...
        return retry_chat_session_turn_workflow(services, session_id, request or ChatSessionRetryRequest())
