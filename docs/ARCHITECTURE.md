...
- `vaults/default/raw/chats/`: AI tool sessions such as Hermes, Codex, OpenClaw, or Claude Code.
- `vaults/default/raw/notes/`: imported Markdown notes.
- `vaults/default/raw/articles/`: web or article exports.
- `vaults/default/raw/documents/originals/`: original rich documents such as PDF, DOCX, PPTX, XLSX, manuals, and course material.
- `vaults/default/raw/documents/markdown/`: Markdown generated by deterministic preprocessors such as a user-managed MinerU-compatible service.
- `vaults/default/raw/transcripts/`: meeting, audio, or video transcripts.
- `vaults/default/raw/datasets/`: structured datasets.
- `vaults/default/raw/media/`: original images and media files.
...
- `maintenance/`, `raw/`, and `.knoarbor/` are not normal knowledge targets.
