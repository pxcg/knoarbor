...
- graph expansion through page links, source relationships, and machine-index page context;
...
- `deterministic`: structured scan and deterministic safe fixes only.
- `semantic`: semantic maintenance over structural, provenance, and quality candidates, with reviewed execution.
