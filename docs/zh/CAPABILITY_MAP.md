...
| Wiki 上下文检索 | 已实现 | Query 返回排序页面、摘录、来源线索、trace 数据和供宿主 AI 使用的 context pack。 | [1.7 CLI/API/Skill Closure](../../specs/1.7-cli-api-skill-closure/requirements.md), [接口说明](API.md) |
