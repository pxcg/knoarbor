...
The console now includes a dedicated Knowledge Base page for browsing generated Markdown pages. It shows page metadata, source fields, summaries, outbound links, backlinks, and page content without requiring users to switch to the filesystem or Obsidian first.
...
- Runtime wiki data remains ignored by git. Do not commit `wiki/`, `.env`, or `config.yaml`.
